        ...
        <Info>
            <div className="info__container">
                ...
                <div className="testimonials">
                    <Testimonial
                        imageSrc="./vpn-frontend/pexels-mariatheodora-andrikopoulou-14390223.jpg"
                    ...
                    />
                    <Testimonial
                        imageSrc="./vpn-frontend/pexels-matt-hardy-5327027.jpg"
                    ...
                    />
                    <Testimonial
                        imageSrc="./vpn-frontend/pexels-mathilde-langevin-15823364.jpg"
